describe('int-input-step', function () {
    'use strict';

    var element;
    var scope;

    beforeEach(module('formControls.intInputStep'));

    describe('with default config', function () {
        beforeEach(inject(function ($rootScope, $compile) {
            scope = $rootScope.$new();

            element = '<form name="testForm"><div name="testInput" ng-model="val" int-input-step></div></form>';
            element = $compile(element)(scope);
            scope.$digest();
        }));

        it('should contain a numerical input', function () {
        ...
        it('should mark controller as $touched on blur', function () {
            element.find('input').focus();
            element.find('input').blur();
            expect(scope.testForm.testInput.$touched).toBe(true);
        });

        it('should mark controller as $touched on click over the increment button', function () {
    ...
    describe('with validation config', function () {
        ...
        it('should mark controls as invalid if the model value is more then max attribute value', function () {
            scope.val = 3;
            var el = '<form name="testForm"><div name="testInput" ng-model="val" max="2" int-input-step></div></form>';
            $compile(el)(scope);
            scope.$digest();
        ...
        it('should mark controls as invalid if the model value is more then min attribute value', function () {
            scope.val = 1;
            var el = '<form name="testForm"><div name="testInput" ng-model="val" min="2" int-input-step></div></form>';
            $compile(el)(scope);
            scope.$digest();
        ...
        it('should mark controls as invalid if the view value is undefined and required="true"', function () {
            var el = '<form name="testForm"><div name="testInput" ng-model="val" required="true" int-input-step></div></form>';
            $compile(el)(scope);
            scope.$digest();
        ...
        it('should mark controls as valid if the view value is undefined and required="false"', function () {
            var el = '<form name="testForm"><div name="testInput" ng-model="val" required="false" int-input-step></div></form>';
            $compile(el)(scope);
            scope.$digest();
        ...
        it('should mark controls as invalid if the view value is undefined and ng-required="true"', function () {
            var el = '<form name="testForm"><div name="testInput" ng-model="val" ng-required="true" int-input-step></div></form>';
            el = $compile(el)(scope);
            scope.$digest();
        ...
        it('should mark controls as valid if the view value is undefined and ng-required="false"', function () {
            var el = '<form name="testForm"><div name="testInput" ng-model="val" ng-required="false" int-input-step></div></form>';
            el = $compile(el)(scope);
            scope.$digest();
        ...
        it('should use an evaluated value of `ng-required` attribute', function () {
            ...
            var el = '<form name="testForm"><div name="testInput" ng-model="val" ng-required="required" int-input-step></div></form>';
            el = $compile(el)(scope);
            scope.$digest();
        ...
        it('should mark controls as valid if the view value matches a RegExp from `ng-pattern` attribute', function () {
            scope.val = 22;
            var el = '<form name="testForm"><div name="testInput" ng-model="val" ng-pattern="/[0-9]{2}/" int-input-step></div></form>';
            el = $compile(el)(scope);
            scope.$digest();
        ...
        it('should use an evaluated value of `ng-pattern` attribute', function () {
            scope.val = 1;
            scope.pattern = /[0-9]{2}/;
            var el = '<form name="testForm"><div name="testInput" ng-model="val" ng-pattern="pattern" int-input-step></div></form>';
            el = $compile(el)(scope);
            scope.$digest();
        ...
        it('should mark controls as valid if the view value matches a RegExp from `pattern` attribute', function () {
            scope.val = 22;
            var el = '<form name="testForm"><div name="testInput" ng-model="val" pattern="[0-9]{2}" int-input-step></div></form>';
            el = $compile(el)(scope);
            scope.$digest();
        ...
        it('should call a callback that is defined as `ng-change` on each change', function () {
            ...
            var el = '<form name="testForm"><div name="testInput" ng-model="val" ng-change="cb" int-input-step></div></form>';
            el = $compile(el)(scope);
            scope.$digest();

            el.find('input').val(121).trigger('change');

            expect(scope.cb).toHaveBeenCalledWith(121, 555);
        });
    });
});